...
@SuppressLint("NewApi")
public class ListServiceActivity extends Activity implements
		OnItemClickListener, OnTaskComplete {
...
//			ImageView title = (ImageView) findViewById(actionBarTitleId);
//			if (title != null) {
//				title.setImageResource(R.drawable.bulletgreen);
//			}
//		}
	...
	private void carregarLista() {
		AdapterLista adapter = new AdapterLista(this, R.layout.custom_listrow,
				servicos);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position,
		...
		dialog = ProgressDialog.show(this, servicoSelecionado.getNomeService(),
				getResources().getString(R.string.testando), false);
